          ...
          {data.map((value, index) => (
            <Table.Row key={index}>
              <Table.Cell>
                ...
                <Link href={`https://liff.line.me/1661407578-X6ro31ow#idevent${value._id}`} target="_blank" className='hover:text-blue-600'>
                  {value.title}
                </Link>                
              </Table.Cell>
              <Table.Cell>
              <Button size="xs" flat data-url={`https://liff.line.me/1661407578-X6ro31ow#idevent${value._id}`} onClick={(e) => handleCopyUrl(e)}>GET LINK</Button>
              </Table.Cell>              
              <Table.Cell>
                {value.campaign}
              </Table.Cell>
                ...
                <Row justify="flex-end" align="center">
                  <Col css={{ width: "auto" }}>
                    <Tooltip content="ข้อมูลอีเวนท์">
                      <Link href={`/dashboard/event/${value._id}`}>
                  ...
                  <Col css={{ width: "auto" , marginLeft : "25px" }}>
                    <Tooltip content="แก้ไขคำถาม">
                      <Link href={`/dashboard/event/edit/${value._id}`}>
