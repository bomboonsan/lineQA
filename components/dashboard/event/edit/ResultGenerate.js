...
export default function ResultGenerate(  { contentResult , countResult }  ) {
  ...
  useEffect(() => {
    ...
    if(contentResult.resultText && contentResult.pointMax && contentResult.pointMin && contentResult.resultImageUrl ) {

      const newResultData = {...resultData}
      newResultData.pointMin = contentResult.pointMin;
      newResultData.pointMax = contentResult.pointMax;
      newResultData.resultText = contentResult.resultText;
      newResultData.resultImageUrl = contentResult.resultImageUrl;
      setResultData(newResultData);
      setUrlThumbnail(contentResult.resultImageUrl)

    }
    
  }, [contentResult.resultText]);
