...
export default function Content( {pageData} ) {
    ...
    return (
        <>
            ...
            <div className={`${dataUser.onPage === 'welcome' ? 'block' : 'd-none'}`}>
                <div className='p-4'>
            ...
            <div className={`${dataUser.onPage === 'contest' ? 'p-4' : 'd-none'}`}>
                <ContestElement pageData={pageData} />
            </div>



            {/* {globalUser.onPage === 'contest' && <ContestElement pageData={pageData} /> } */}
