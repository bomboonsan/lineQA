...
export default function Result( {pageData} ) {
  ...
  useEffect(() => {
    ...
    if (pageData.results) {
      ...
      setUrlSharedExternal(`https://boschthailand.aclick.asia/result?id=${pageData._id}&name=${encodeURIComponent(globolUser.displayName)}&point=${globolUser.point}?openExternalBrowser=1`)
        ...
        <main className="mt-10">
          ...
          <section className='p-3'>
            <div className='mt-5'>
              ...
              <div className='mt-3'>
                <button className="btn btn-block btn-error text-xl text-white rounded-[0px]" onClick={link}>
